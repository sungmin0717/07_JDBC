...
public class JDBCExample1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*2. DriverManaer 객체를 이용해서 Connection 객체를 사용하기. */
			...
			// OracleDriver.jdbc.driver.OracleDriver
			// -Oracle DBMS 연결 시 필요한 코드가 담겨잇는 클래스
			// (Oracle에서 만들어서 준 클래스)
			...
			while(rs.next()){
				...
				("사번 : %s / 이름 : %s / 부서코드 : %s / 직급코드 : %s / 급여 : %d / 입사일 : %s \n"
							,empId,empName,deptCode,job_Code,salary,hireDate.toString());
			}
